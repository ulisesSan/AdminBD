...
namespace formulario {
    ...
    public partial class bancoDataSet2 : global::System.Data.DataSet {
        ...
        public partial class clienteDataTable : global::System.Data.TypedTableBase<clienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public clienteRow AddclienteRow(uint id_cliente, uint id_cuenta, string nombres, string apellidos, string correo, ulong telefono) {
...
namespace formulario.bancoDataSet2TableAdapters {
    ...
    public partial class clienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `cliente` WHERE ((`id_cliente` = @p1) AND ((@p2 = 1 AND `id_cuenta` IS NULL) OR (`id_cuenta` = @p3)) AND ((@p4 = 1 AND `nombres` IS NULL) OR (`nombres` = @p5)) AND ((@p6 = 1 AND `apellidos` IS NULL) OR (`apellidos` = @p7)) AND ((@p8 = 1 AND `correo` IS NULL) OR (`correo` = @p9)) AND ((@p10 = 1 AND `telefono` IS NULL) OR (`telefono` = @p11)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `cliente` (`id_cuenta`, `nombres`, `apellidos`, `correo`, `telefono`)" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `cliente` SET `id_cuenta` = @p1, `nombres` = @p2, `apellidos` = @p3, `correo` = @p4, `telefono` = @p5 WHERE ((`id_cliente` = @p6) AND ((@p7 = 1 AND `id_cuenta` IS NULL) OR (`id_cuenta` = @p8)) AND ((@p9 = 1 AND `nombres` IS NULL) OR (`nombres` = @p10)) AND ((@p11 = 1 AND `apellidos` IS NULL) OR (`apellidos` = @p12)) AND ((@p13 = 1 AND `correo` IS NULL) OR (`correo` = @p14)) AND ((@p15 = 1 AND `telefono` IS NULL) OR (`telefono` = @p16)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT `id_cliente`, `id_cuenta`, `nombres`, `apellidos`, `correo`, `telefono` FR" +
                "OM `cliente`";
        ...
        public virtual int Fill(bancoDataSet2.clienteDataTable dataTable) {
        ...
        public virtual bancoDataSet2.clienteDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            bancoDataSet2.clienteDataTable dataTable = new bancoDataSet2.clienteDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(bancoDataSet2.clienteDataTable dataTable) {
        ...
        public virtual int Delete(uint p1, global::System.Nullable<uint> p3, string p5, string p7, string p9, global::System.Nullable<ulong> p11) {
        ...
        public virtual int Insert(global::System.Nullable<uint> p1, string p2, string p3, string p4, global::System.Nullable<ulong> p5) {
            if ((p1.HasValue == true)) {
        ...
        public virtual int Update(global::System.Nullable<uint> p1, string p2, string p3, string p4, global::System.Nullable<ulong> p5, uint p6, global::System.Nullable<uint> p8, string p10, string p12, string p14, global::System.Nullable<ulong> p16) {
            if ((p1.HasValue == true)) {
            ...
            if ((p16.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((ulong)(p16.Value));
            }
            else {
